...
<head>
  ...
  <title>OpenOffice style files for JabRef</title>
...
<body>
  <div id="main">
    <div id="container">
      ...
      <h1>OpenOffice style files for JabRef</h1>

      <p>The list below contains style files for the JabRef OpenOffice/LibreOffice plugin that have been
      contributed by users. To use the styles below, make sure to download the linked .jstyle files directly
