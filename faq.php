...
&nbsp;  url = {http://jabref.sf.net},<br/>
	  ...
	  <p class="answer">A: No, it is not possible any more. See <a href="https://sourceforge.net/p/jabref/bugs/1241/">bug #1241</a>. Meanwhile, you can use the <a href="http://manas.tungare.name/software/isbn-to-bibtex/">online service</a> by Manas Tungare. <strike>Follow the instructions for converting a DOI. Instead of the &ldquo;DOI to BibTeX&rdquo; fetcher, use &ldquo;ISBN to BibTeX&rdquo;.</strike></p>
