...
<body>
  <div id="container">
	...
	under the terms of the GNU <a href="License.php">General Public
	...
	version 2 of the License, or (at your option) any later version.</p>
        ...
        which are distributed under <a href="jgoodies.php">these
        terms</a>.</p>

        <p>Command line options are parsed using RitOpt
        (<code>http://ritopt.sourceforge.net</code>). RitOpt is
        distributed under the terms of the GNU
        <a href="License.php">General Public License</a>, version
        2 (or later).</p>
