...
<body>
  <div id="container">
    ...
    <em>BibTeX</em> style (Stildatei .bst) Gro&szlig;buchstaben
    verkleinern. Um sicherzustellen, dass einzelne Buchstaben
    gro&szlig; bleiben, m&uuml;ssen Sie sie in Klammern
    einschlie&szlig;en, wie im Wort {B}elgien. <em>(Anm. d.
    &Uuml;bers.: Die meisten deutschen BibTeX-Stile behalten
    die Gro&szlig;buchstaben ohnehin bei.)</em></p>
    ...
    <ul>
        ...
        k&ouml;nnen Sie den
        <a href="StringEditorHelp.php">String-Editor</a> benutzen
        oder die Funktionalit&auml;t zur
        <a href="JournalAbbreviations.php">Abk&uuml;rzung von
        ...
        nicht mit dem <tt>Bibtexkey</tt>, der f&uuml;r die
        ...
        englischer Bibliographiestile gro&szlig; geschrieben werden
        ...
        <tt>1984</tt>. Die Standardstile k&ouml;nnen aber auch mit
        <tt>year</tt>-Eintr&auml;gen umgehen, deren letzte vier
