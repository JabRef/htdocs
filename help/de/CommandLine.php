...
<body>
  <div id="container">
    ...
    auflisten. Achten Sie darauf, alle gew&uuml;nschten Optionen
    anzugeben, bevor Sie die Dateinamen anf&uuml;gen.
    Au&szlig;erdem m&uuml;ssen Sie sich vergewissern, dass der
    ...
    Dateinamen steht, m&uuml;ssen Sie also "true" als Argument
    angeben. Das Beispielkommando:</p>

    <p><code>jabref -o filetoexport.xml,docbook -n true
    original.bib</code></p>

    <p>l&auml;dt die Datei <code>original.bib</code>, exportiert
    sie in das Docbook-Format, speichert sie unter dem Namen
    <code>filetoexport.xml</code> und unterdr&uuml;ckt das Laden
    der grafischen Oberfl&auml;che. Das Word <em>true</em>
    ...
    einem der von JabRef unterst&uuml;tzten Importformate
    ...
    oder geladene Datei an den Exportfilter &uuml;bergeben wird.
    Falls die grafische Oberfl&auml;che nicht mit der Option
    <code>-n</code> unterdr&uuml;ckt wird, werden alle geladenen
    ...
    <p>Mit der Option <code>-h</code> k&ouml;nnen Sie sich eine
    Liste der verf&uuml;gbaren Exportformate anzeigen lassen.</p>

    <p>Falls die Option <code>-n</code> nicht aufgerufen wurde,
    wird jeder Exportvorgang durchgef&uuml;hrt, bevor das
    JabRef-Fenster ge&ouml;ffnet wird. Dort werden dann die
