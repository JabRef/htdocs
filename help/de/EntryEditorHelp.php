...
<body>
  <div id="container">
    ...
    &uuml;berpr&uuml;ft den Eintragstyp und zeigt alle
    ben&ouml;tigten und optionalen Felder f&uuml;r den Gebrauch mit
    <em>BibTeX</em> an. Dar&uuml;ber hinaus gibt es einige Felder,
    die <em>Allgemeine Felder</em> genannt werden und f&uuml;r alle
    Eintragstypen gelten.</p>

    <p>Sie k&ouml;nnen die Felder, die f&uuml;r die einzelnen
    Eintragstypen als ben&ouml;tigt und optional angesehen werden,
    und auch die Allgemeinen Felder anpassen. Schlagen Sie unter
    <a href="CustomEntriesHelp.php">Eintragstypen anpassen</a>
    nach, wenn Sie mehr Informationen dar&uuml;ber erhalten
    m&ouml;chten.</p>

    <p>N&auml;here Informationen dar&uuml;ber, was in die Felder
    ...
    Panel links vom aktuellen Panel. Au&szlig;erdem k&ouml;nnen Sie
    zum n&auml;chsten oder vorherigen Eintrag wechseln, indem Sie
    "STRG-SHIFT-Pfeil nach unten" bzw. "STRG-SHIFT-Pfeil nach oben"
    oder die Pfeiltasten in der linken Toolbar dr&uuml;cken.</p>

    <p>Das Panel <em>BibTeX Quelltext</em> zeigt, wie der Eintrag
    aussehen wird, wenn die Datei im <em>bibtex</em>-Format
    gespeichert wird. Wenn Sie wollen, k&ouml;nnen Sie den
    <em>BibTeX</em> Quelltext direkt bearbeiten. Sobald Sie zu
    einem anderen Panel wechseln, STRG-S dr&uuml;cken oder den
    Eintrags-Editor schlie&szlig;en, wird JabRef versuchen, den
    Inhalt des Quelltext-Panels zu analysieren. Falls dabei
    Probleme auftreten, werden Sie benachrichtigt und erhalten die
    M&ouml;glichkeit, den Eintrag noch einmal zu &uuml;berarbeiten
    ...
    standardm&auml;&szlig;ig anzeigen</strong> gew&auml;hlt wurde,
    wird das Quelltext-Panel beim &Ouml;ffnen des Eintrags-Editors
    als erstes angezeigt. Wenn Sie lieber den Quelltext bearbeiten
    als die anderen Panels zu benutzen, sollten Sie diese Option
    w&auml;hlen.</p>

    <p><strong>Tip:</strong> Wenn Ihre Datei Felder enth&auml;lt,
    ...
    &uuml;berpr&uuml;ft. Das "hash"-Symbol darf <em>nur</em>
    paarweise benutzt werden, um damit den Namen eines
    <em>BibTeX</em>-Strings einzuschlie&szlig;en. Beachten Sie,
