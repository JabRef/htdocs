...
<body>
  <div id="container">
    ...
    &Ouml;ffnen der Dateien. Wenn Sie Windows benutzen, k&ouml;nnen
    ...
    des Eintrags &uuml;bereinstimmt. Die Regeln, nach denen
    Dateinamen mit BibTeX-Keys automatisch verkn&uuml;pft werden,
    k&ouml;nnen eingestellt werden unter <b>Einstellungen -&gt;
    Externe Programme -&gt; Links zu externen Dateien -&gt; Suche
    mit regul&auml;rem Ausdruck benutzen</b>.</p>

    <p>Um eine Datei herunterzuladen und mit einem Eintrag zu
    verlinken, benutzen Sie die Schaltfl&auml;che <b>Download</b>
    im Eintrags-Editor. Es erscheint ein Dialog, in dem Sie den URL
    eingeben m&uuml;ssen. Die Datei wird dann in Ihr
    ...
    Tastenk&uuml;rzel oder dem Kontextmen&uuml; den ersten externen
    Link &ouml;ffnen. Falls in der Tabellenansicht die Spalte
    <b>file</b> angezeigt wird (<b>Einstellungen -&gt;
    Tabellenansicht -&gt; Spezielle Spalten -&gt; Datei-Spalten
    anzeigen</b>), k&ouml;nnen Sie auch auf das Icon klicken, um
