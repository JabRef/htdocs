...
<body>
  <div id="container">
    ...
    <ul>
        ...
        in JabRef mehreren Gruppen angeh&ouml;ren.</li>

        <li>Gruppen benutzen bestimmte Kriterien, um ihren Inhalt
        dynamisch zu bestimmen. Neue Eintr&auml;ge, die den
        Kriterien einer Gruppe entsprechen, geh&ouml;ren
        automatisch zu dieser Gruppe. Diese Funktionalit&auml;t
        gibt es nicht in &uuml;blichen Dateisystemen, wohl aber in
        einigen E-Mail-Programmen (z.B. Thunderbird und
        Opera).</li>
    </ul>Wenn Sie eine Gruppe ausw&auml;hlen, werden die
    Eintr&auml;ge dieser Gruppe angezeigt. Wenn Sie mehrere Gruppen
    ausw&auml;hlen, werden entweder die Eintr&auml;ge angezeigt,
    ...
    <table cellspacing="0"
        ...
        <tr>
            <td>
                ...
                dr&uuml;cken OK. Sie k&ouml;nnen alle Einstellungen
                auf ihren Standardwerten belassen. Jetzt
                w&auml;hlen Sie die Eintr&auml;ge aus, die der
                Gruppe zugeordnet werden sollen, und ziehen diese
                mit der Maus auf die Gruppe oder w&auml;hlen <b>Zu
                Gruppe hinzuf&uuml;gen</b> aus dem
                ...
                Option <b>Dynamisches Gruppieren der Eintr&auml;ge
                anhand eines Stichworts in einem Feld</b>. Geben
                Sie das Stichwort, nach dem gesucht werden soll,
                ein und dr&uuml;cken OK. Jetzt k&ouml;nnen Sie die
                ...
                der Eintr&auml;ge anhand eines beliebigen
                ...
                vorkommt) und klicken <b>OK</b>. Jetzt k&ouml;nnen
                ...
                Gruppe und anschlie&szlig;end bei gedr&uuml;ckter
                STRG-Taste auf die andere Gruppe). Sie sollten
                jetzt alle Eintr&auml;ge sehen, die in einer der
                beiden Gruppen aufgef&uuml;hrt sind. Klicken Sie
                noch einmal auf <b>Einstellungen</b> und
                w&auml;hlen <b>Schnittmenge</b> aus. Nun sollten
                Sie nur die Eintr&auml;ge sehen, die in beiden
                ...
                ausgew&auml;hlten Gruppe ist). Klicken Sie auf
    ...
    <ol>
        ...
        Name vermuten l&auml;sst -- alle Eintr&auml;ge beinhaltet,
        ist immer vorhanden und kann weder ver&auml;ndert noch
        gel&ouml;scht werden.</li>

        <li><b>Statische Gruppen</b> verhalten sich wie Ordner auf
        einer Festplatte und beinhalten nur die Eintr&auml;ge, die
        Sie ihnen explizit zuweisen.</li>

        <li><b>Dynamische Gruppen basierend auf einem Stichwort</b>
        beinhalten Eintr&auml;ge, die in einem bestimmten
        BibTeX-Feld (z.B. <tt>keywords</tt>) ein bestimmtes
        Stichwort (z.B. <tt>elektrisch</tt>) aufweisen. Diese
        Methode ben&ouml;tigt kein manuelles Zuweisen der
        Eintr&auml;ge, sondern nutzt die bereits in der Datei
        vorhandenen Informationen. Wenn alle Eintr&auml;ge in Ihrer
        Datenbank passende Stichw&ouml;rter haben, k&ouml;nnte
        diese Art von Gruppe die beste Wahl f&uuml;r Sie sein.</li>

        <li><b>Dynamische Gruppen basierend auf einer freien
        Suche</b> beinhalten Eintr&auml;ge, die mit einem
        ...
        flexiblere Definition von Gruppen m&ouml;glich als mit
    ...
    hinzuf&uuml;gen, entweder auf derselben Ebene wie die
    ausgew&auml;hlte Gruppe oder als ihre Untergruppe. Der Button
    <b>Neue Gruppe</b> erzeugt eine neue Untergruppe der Gruppe
    <b>Alle Eintr&auml;ge</b>, egal ob Sie gerade Gruppen
    ausgew&auml;hlt haben oder nicht. Im Kontextmen&uuml;
    k&ouml;nnen Sie auch Gruppen und/oder Untergruppen
    l&ouml;schen, Untergruppen alphabetisch sortieren oder Gruppen
    ...
    entweder Drag&nbsp;&amp;&nbsp;Drop oder das Kontextmen&uuml; in
    ...
    <dl>
        ...
        keywords=linear</tt> Eintr&auml;ge, die sich mit
        nicht-linearer Regression besch&auml;ftigen, zu einer
        Gruppe zusammen.</dd>
    ...
    Verwenden dynamischer Gruppen -- oft n&uuml;tzlich, eine
    Untergruppe zu erstellen, die <b>ihre Obergruppe
    verfeinert</b>. Wenn diese Untergruppe ausgew&auml;hlt wird,
    werden alle Eintr&auml;ge dieser Gruppe und ihrer Obergruppe
    angezeigt. Erstellen Sie z.B. eine Obergrupe, die Eintr&auml;ge
    mit dem Stichwort <tt>Verteilung</tt> enth&auml;lt, sowie eine
    verfeinernde Untergruppe mit Eintr&auml;gen, die das Stichwort
    <tt>Gau&szlig;</tt> enthalten. Wenn Sie nun die Untergruppe
    ausw&auml;hlen, werden alle Eintr&auml;ge angezeigt, die beiden
    Bedingungen entsprechen, also alle, die mit Gau&szlig;'scher
    Verteilung zu tun haben. Indem Sie nun eine weitere Untergruppe
    f&uuml;r <tt>Laplace</tt> anlegen, die dieselbe Obergruppe
    ...
    ber&uuml;cksichtigt</b>. Wird sie ausgew&auml;hlt, werden nicht
    nur die Eintr&auml;ge dieser Gruppe, sondern auch diejenigen
    ...
    die Schnittmenge ihrer Inhalte angezeigt. Damit k&ouml;nnen
    mehrere Bedingungen schnell miteinander kombiniert werden. Ein
    Beispiel: Wenn Sie eine statische Gruppe <tt>Sehr wichtig</tt>
    haben, in der alle sehr wichtigen Eintr&auml;ge sind,
    k&ouml;nnen Sie sich die sehr wichtigen Eintr&auml;ge jeder
    ...
    enthalten, der auch der ausgew&auml;hlten Gruppe zugeordnet
    ist. Damit k&ouml;nnen Sie schnell &Uuml;berschneidungen
    zwischen den Eintr&auml;gen verschiedener Gruppen erkennen. Sie
    k&ouml;nnten beispielsweise eine Gruppe <tt>lesen</tt>
    ...
    W&ouml;rter eines bestimmten Felds Ihrer Wahl und erstellt eine
    Gruppe f&uuml;r jedes Wort. Das ist zum Beispiel n&uuml;tzlich,
    wenn Ihre Datei geeignete Stichworte f&uuml;r alle
    ...
    kombinierte Stichworte wie etwa <tt>Gau&szlig;'sche
    Verteilung</tt> als semantische Einheit interpretiert werden
    k&ouml;nnen. (Sie k&ouml;nnen diese Option allerdings nicht
    verwenden, um ganze W&ouml;rter zu ignorieren. Sie m&uuml;ssen
