...
<body>
  <div id="container">
    ...
    wird in den Hilfedateien h&auml;ufig erw&auml;hnt.
    ...
    (Dateiendung .bib) laden und speichern. Sie k&ouml;nnen aber
    auch bibliographische Datenbanken in anderen Formaten in JabRef
    importieren.</p>

    <p>JabRef unterst&uuml;tzt Sortier- und Suchfunktionen, um
    einen &Uuml;berblick &uuml;ber den Inhalt Ihrer Datei zu
    bekommen. Sie k&ouml;nnen der Datei ganz einfach neue
    Eintr&auml;ge hinzuf&uuml;gen, ohne sich daran erinnern zu
    m&uuml;ssen, welche Informationen ben&ouml;tigt werden.
    Au&szlig;erdem kann JabRef <em>BibTeX</em> keys automatisch
    generieren. JabRef ist sehr n&uuml;tzlich, wenn Sie
    <em>BibTeX</em> oder CiteMaker benutzen, kann aber auch
    f&uuml;r diejenigen sinnvoll sein, die andere
    Bibliographie-Systeme benutzen oder schlicht und einfach ihre
    Literaturquellen organisieren wollen.</p>

    <p><a href="BaseFrameHelp.php">Das Hauptfenster von
    JabRef</a></p>
