...
<body>
  <div id="container">
    ...
    Zeitschriftenlisten enthalten ist. Sie k&ouml;nnen mehrere
    dieser Listen benutzen, die Sie als externe Textdateien
    anlegen.</p>

    <h2>Benutzungshinweise</h2>

    <p>Die Abk&uuml;rzung von Zeitschriftentiteln k&ouml;nnen Sie
    von Eintragseditor oder vom Men&uuml; <b>Extras</b> aus ein-
    und ausschalten. Im Eintragseditor benutzen Sie dazu den Button
    <b>Abk&uuml;rzung an-/abschalten</b> neben dem
    ...
    Eintr&auml;gen ausw&auml;hlen und im Men&uuml; <b>Extras</b>
    einen der Eintr&auml;ge <b>Zeitschriftennamen abk&uuml;rzen
    (ISO)</b>, <b>Zeitschriftennamen abk&uuml;rzen (MEDLINE)</b>
    und <b>Abk&uuml;rzung der Zeitschriften aufheben</b>
    w&auml;hlen. Diese drei Aktionen sorgen daf&uuml;r, dass bei
    allen ausgew&auml;hlten Eintr&auml;gen die Zeitschriftennamen,
    ...
    die Sie als Grundlage nehmen wollen, w&auml;hlen Sie
    ...
    entfernen. F&uuml;r jeden Eintrag m&uuml;ssen Sie den
    vollst&auml;ndigen Zeitschriftennamen und die
    ISO-Abk&uuml;rzung angeben (z.B. "Aquacultural Engineering" und
    "Aquacult. Eng."). Mit einem Doppelklick auf die Tabellenzeile
    k&ouml;nnen Sie die Eintr&auml;ge bearbeiten.</p>

    <p>Sobald Sie auf <b>OK</b> klicken (oder wenn Sie eine
    bestehende Datei ausgew&auml;lt haben), enth&auml;lt die
    ...
    f&uuml;gt eine weitere Zeile hinzu). Dann benutzen Sie entweder
    den <b>Durchsuchen</b>- oder den
    <b>Herunterladen</b>-Button.</p>

    <ul>
        <li>Mit dem <b>Durchsuchen</b>-Knopf k&ouml;nnen Sie eine
        auf Ihrem Computer bestehende Datei ausw&auml;hlen.</li>

        <li>Mit dem <b>Herunterladen</b>-Knopf k&ouml;nnen Sie eine
        Liste aus dem Internet herunterladen, indem Sie eine URL
        angeben. Die Datei wird auf Ihrem Computer gespeichert und
        mit JabRef verlinkt. Die URL ist standardm&auml;&szlig;ig
        die Adresse einer Zeitschriftenliste auf der
        JabRef-Homepage. Diese Liste ist unvollst&auml;ndig, wird
        in Zukunft aber ausgebaut.</li>
    </ul>Jeder Eintrag in Ihrer pers&ouml;nlichen Liste
    &uuml;berschreibt einen Eintrag mit demselben
