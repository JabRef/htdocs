...
<body>
  <div id="container">
    ...
    <a href="Contents.php">Retour au contenu</a>
        ...
        <a href="../License.php">General Public License</a>
        ...
        distribu&eacute;s par JGoodies
        ...
        qui sont distribu&eacute;es sous
        <a href="../jgoodies.php">ces termes</a>.</p>

        <p>Les options de la ligne de commande sont trait&eacute;es
        en utilisant RitOpt
        (<code>http://ritopt.sourceforge.net</code>). RitOpt est
        distribu&eacute;e selon les termes de la GNU
        <a href="../License.php">General Public License</a>,
