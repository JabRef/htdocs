...
<body>
  <div id="container">
    ...
    de r&eacute;f&eacute;rences et les champs qui sont inclus dans
    ces listes seront mis en majuscules/minuscules selon votre
    style bibliographique. Pour &ecirc;tre certain que certains
    caract&egrave;res restent en majuscules, encadrez-les par des
    accolades, comme dans le mot {B}elgique.</p>

    <p>Notes &agrave; propos de certains types de champs&nbsp;:</p>

    <ul>
        <li><strong style="font-style: italic;">Bibtexkey</strong>
        C'est une cha&icirc;ne unique utilis&eacute;e pour
        r&eacute;f&eacute;rencer l'entr&eacute;e dans les documents
        ...
        recommande d'omettre compl&egrave;tement cette information.
        Pour les petites maisons d'&eacute;dition, d'un autre
        ...
        <a href="StringEditorHelp.php">l'&eacute;diteur de
        cha&icirc;nes</a>.</li>
        ...
        l'abr&eacute;viation standard &agrave; trois lettres (jan,
        ...
        identifi&eacute;s par leur volume et leur
        num&eacute;ro&nbsp;; l'organisation qui publie un rapport
        technique lui donne en g&eacute;n&eacute;ral un
        num&eacute;ro&nbsp;; et parfois les livres portent des
        ...
        garder facilement la compatibilit&eacute; avec les bases de
        donn&eacute;es compatibles <em>Scribe</em>, les styles
        standards convertissent le tiret simple (comme dans
        <tt>7-33</tt>) en un tiret double utilis&eacute; par TeX
        ...
        styles standards peuvent g&eacute;rer toute valeur de
        <tt>year</tt> dont les quatre derniers caract&egrave;res
    ...
    <ul>
        ...
        afin d'indiquer le site ftp o&ugrave; la source postscript
        du rapport est localis&eacute;e.</li>
    </ul>
