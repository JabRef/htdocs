...
<body>
  <div id="container">
    ...
    Prenez la pr&eacute;caution de sp&eacute;cifier l'ensemble des
    options avant la liste des fichiers. Vous devez toujours
    v&eacute;rifier que le premier nom de fichier ne sera pas
    compris comme l'argument d'une option - cela veut simplement
    dire que si une option de type logique comme <code>-n</code> ou
    <code>-l</code> pr&eacute;c&egrave;de imm&eacute;diatement un
    ...
    graphique. Le mot <em>true</em> &eacute;vite que le nom de
    ...
    g&eacute;n&eacute;rer un nouveau fichier BibTeX qui ne
