...
<body>
  <div id="container">
    ...
    entr&eacute;e donn&eacute;e. L'&eacute;diteur d'entr&eacute;es
    v&eacute;rifie le type de votre entr&eacute;e et affiche tous
    les champs qui sont requis ou optionnels pour que
    <em>BibTeX</em> traite l'entr&eacute;e. De plus, il y a
    plusieurs champs, appel&eacute;s <em>Champs
    g&eacute;n&eacute;raux</em>, qui sont communs &agrave; tous les
    types d'entr&eacute;es.</p>

    <p>Vous pouvez personnaliser compl&egrave;tement les champs qui
    doivent &ecirc;tre consid&eacute;r&eacute;s comme requis ou
    optionnel pour chaque type d'entr&eacute;e, ainsi que les
    champs apparaissant dans l'onglet G&eacute;n&eacute;ral. Voir
    <a href="CustomEntriesHelp.php">Personnaliser les types
    d'entr&eacute;es</a> pour plus d'informations &agrave; ce
    sujet.</p>

    <p>Pour des informations sur la fa&ccedil;on de remplir les
    ...
    Les onglets <em>G&eacute;n&eacute;ral</em>, <em>Abstract</em>
    et <em>Review</em> peuvent &ecirc;tre personnalis&eacute;s
    ...
    d&eacute;placer vers la gauche ou la droite&nbsp;: CTRL-TAB ou
    CTRL-PLUS affiche l'onglet &agrave; droite, et CTRL-MAJ-TAB ou
    CTRL-MOINS affiche l'onglet &agrave; gauche. Vous pouvez aussi
    afficher l'entr&eacute;e pr&eacute;c&eacute;dente ou suivante
    en appuyant respectivement sur CTRL-MAJ-DOWN ou CTRL-MAJ-UP,
    ainsi qu'en cliquant sur les boutons de la barre d'outils de
    l'&eacute;diteur d'entr&eacute;es.</p>

    <p>L'onglet <em>Source BibTeX</em> montre comment
    l'entr&eacute;e appara&icirc;tra lorsque la base de
    donn&eacute;es sera sauvegard&eacute;e au format
    <em>BibTeX</em>. Si vous le souhaitez, vous pouvez
    &eacute;diter la source <em>BibTeX</em> directement dans cet
    onglet. Lorsque vous changez d'onglet, que vous appuyez sur
    CTRL-S ou que vous fermez l'&eacute;diteur d'entr&eacute;es,
    JabRef essayera de traiter le contenu de l'onglet <em>Source
    BibTeX</em>. S'il y a des probl&egrave;mes, vous en serez
    inform&eacute;&nbsp;; vous pourrez alors &eacute;diter &agrave;
    nouveau votre entr&eacute;e ou r&eacute;tablir son contenu
    initial. Si <strong>Par d&eacute;faut, afficher l'onglet Source
    BibTeX</strong> est coch&eacute; dans les options
    <strong>G&eacute;n&eacute;ral</strong> de la fen&ecirc;tre de
    dialogue <strong>Pr&eacute;f&eacute;rences</strong>, l'onglet
    <em>Source BibTeX</em> sera affich&eacute; par d&eacute;faut
    chaque fois que l'&eacute;diteur d'entr&eacute;es sera ouvert.
    Si vous pr&eacute;f&eacute;rez &eacute;diter la source au lieu
    ...
    ins&eacute;rer l'URL et t&eacute;l&eacute;charger le
    fichier.</p>
    ...
    l'utilisation du caract&egrave;re '#'. Le symbole di&egrave;se
    ...
    <h2>Autocompl&eacute;tion de mot/nom</h2>

    <p>L'&eacute;diteur d'entr&eacute;e permet l'autocompl&eacute;tion des mots.
    Dans le fen&ecirc;tre de dialogue Pr&eacute;f&eacute;rences vous pouvez activer ou
    d&eacute;sactiver l'autocompl&eacute;tion et choisir pour quels champs elle est
    active.</p>

    <p>Avec l'autocompl&eacute;tion, JabRef enregistre tous les mots qui
    apparaissent dans chacun des champs choisis au sein de votre
    base de donn&eacute;es. D&egrave;s que vous tapez le d&eacute;but d'un de ces mots,
    il vous sera sugg&eacute;r&eacute; visuellement. Pour ignorer cette suggestion,
    continuez simplement &agrave; taper. Pour accepter la suggestion, pressez
    <em>ENTREE</em> ou utilisez les fl&egrave;ches du clavier ou d'autres
    touches pour supprimer la bo&icirc;te de s&eacute;lection autour des caract&egrave;res
    sugg&eacute;r&eacute;s.</p>

    <p><em>Note&nbsp;:
    </em> Les mots pris en compte pour la compl&eacute;tion sont seulement ceux
    apparaissant, au sein de la base de donn&eacute;es en cours, dans le m&ecirc;me
    champ que celui que vous &ecirc;tes en train d'&eacute;diter. Il existe de
    nombreuses fa&ccedil;ons de mettre en place cette fonctionnalit&eacute; et si vous
    pensez qu'il devrait &ecirc;tre impl&eacute;ment&eacute; diff&eacute;remment, nous appr&eacute;cierons
    vos suggestions&nbsp;!</p>
    ...
    de votre entr&eacute;e et la commande vers le presse-papier.</p>

    <h2>Copier une clef <em>BibTeX</em></h2>

    <p>En appuyant CTRL-SHIFT-K copie la clef <em>BibTeX</em>
    de votre entr&eacute;e vers le presse-papier.</p>
