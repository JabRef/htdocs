...
<body>
  <div id="container">
    ...
    <p>La conversion de noms de journaux peut &ecirc;tre
    effectu&eacute;e depuis l'&eacute;diteur d'entr&eacute;es ou
    depuis le menu <b>Outils</b>. Dans l'&eacute;diteur
    d'entr&eacute;es, vous trouverez un bouton nomm&eacute;
    <i>Masquer/afficher l'abr&eacute;viation</i> &agrave; droite du
    ...
    <ul>
        ...
        <li>Abr&eacute;viation ISO, par exemple "Aquacult.
        Eng."</li>
    ...
    entr&eacute;es et choisir <b>Outils -&gt; Abr&eacute;ger les
    noms de journaux (ISO)</b>, <b>Outils -&gt; Abr&eacute;ger les
    noms de journaux (MEDLINE)</b> ou <b>Outils -&gt;
    D&eacute;velopper les noms des journaux</b>. Ces trois actions
    abr&eacute;geront ou d&eacute;velopperont les noms de journaux
    pour toutes les entr&eacute;es s&eacute;lectionn&eacute;es dont
    ...
    d'abr&eacute;viations de journaux, choisissez <i>Nouveau
    fichier</i>, et entrez manuellement le nom du fichier ou
    utilisez le bouton <i>Explorer</i>. Si vous disposez
    d&eacute;j&agrave; d'un fichier que vous souhaitez utiliser
    ...
    entr&eacute;es de journaux. Pour chaque entr&eacute;e, vous
    devez fournir le nom complet du journal et son
    abr&eacute;viation ISO (par exemple "Aquacultural Engineering"
    et "Aquacult. Eng."). Pour &eacute;diter une entr&eacute;e,
    double-cliquez sur sa ligne dans la table.</p>

    <p>Une fois que vous avez cliqu&eacute; sur <i>OK</i>, si vous
    avez s&eacute;lectionn&eacute; un fichier et que la table
    contient au moins une entr&eacute;e, le contenu de la table
    ...
    &agrave; l'interface. Ensuite, utilisez soit le bouton
    <i>Explorer</i> soit le bouton <i>T&eacute;l&eacute;charger</i>
    situ&eacute; &agrave; cot&eacute; d'une des entr&eacute;es de
    la partie inf&eacute;rieure de la fen&ecirc;tre.</p>

    <ul>
        <li>Le bouton <i>Explorer</i> vous permet de
        s&eacute;lectionner un fichier existant sur votre
        ordinateur.</li>

        <li>Le bouton <i>T&eacute;l&eacute;charger</i> vous permet
        de t&eacute;l&eacute;charger une liste depuis l'internet en
        entrant une URL, de la stocker dans un fichier local sur
        votre ordinateur et de la lier comme une liste de journaux
        depuis JabRef. L'URL sera par d&eacute;faut l'adresse de la
        liste de journaux disponible depuis la page web de JabRef.
        Cette liste est incompl&egrave;te mais pourra &ecirc;tre
        am&eacute;lior&eacute;e dans le futur.</li>
    </ul>Toute entr&eacute;e dans votre liste personnelle de
    journaux sera prioritaire devant une entr&eacute;e ayant le
