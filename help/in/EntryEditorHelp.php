...
<h1>Penyunting entri</h1>
    ...
    <a href="GeneralFields.php">Pengaturan bidang umum</a> untuk
    ...
    <a href="LabelPatterns.php">Pengaturan pembuat kunci BibTex</a>.</p>
