...
<head>
  ...
  <title>JabRef 第 2.9.1dev 版</title>
...
<body>
  <div id="container">
    ...
    <a href="Contents.php">目次に戻る</a>
        ...
        <p>コマンドラインオプションは、RitOpt (<code>http://ritopt.sourceforge.net</code>) を使用して解析しています。RitOptは、GNU <a href="License.php">General Public License</a>, version 2の下で配布されています。</p>
