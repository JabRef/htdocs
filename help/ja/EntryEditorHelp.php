...
<h1>項目エディタ</h1>
    ...
    <p>項目型のそれぞれについて、どのフィールドが必須で、どのフィールドが非必須か、またどのフィールドが汎用フィールドタブに表示されるべきかを、完全に指定することができます。これについて詳しくは、<a href="CustomEntriesHelp.php">項目型のカスタマイズ</a>を参照してください。</p>

    <p>フィールドをどのように埋めていくべきかについての情報は、<a href="BibtexHelp.php">Bibtexヘルプ</a>をご覧ください。</p>

    <h2>項目エディタのパネル</h2>

    <p>項目エディタには、<em>必須フィールド</em>・<em>非必須フィールド</em>・<em>汎用</em>・<em>概要</em>・<em>レビュー</em>・<em>BibTeXソース</em>の6つのパネルがあります。ここで、<em>汎用</em>・<em>概要</em>・<em>レビュー</em>はカスタマイズ可能です(<a href="GeneralFields.php">汎用フィールドのカスタマイズ</a>を参照)。最初の3つのパネルでは、TABとSHIFT-TABがテキストフィールド間でフォーカスを移すのに使用できます。</p>
...
<!--<h2>Word/name autocompletion</h2>
    ...
    <p>JabRefがどうやって<em>bibtex</em>キーを生成するかについての詳しい情報は、<a href="LabelPatterns.php">BibTeXキーの生成をカスタマイズする</a>をご覧ください。</p>
