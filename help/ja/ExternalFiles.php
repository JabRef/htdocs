...
<head>
  ...
  <title>JabRef における PDF/PS/URL/DOI リンク</title>
...
<body>
  <div id="container">
    ...
    <p><b>《註》</b>JabRef 2.3以降の版は、<a href="FileLinks.php">改善された外部ファイルリンクシステム</a>を装備しています。</p>
    ...
    <p><b>《註》</b>項目エディタ(の「汎用」パネル)にPSフィールドが表示されないときは、<a href="GeneralFields.php">汎用フィールドの項目型をカスタマイズ</a>しなくてはならないかもしれません。</p>
