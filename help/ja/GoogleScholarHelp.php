...
<body>
  <div id="container">
    ...
    <p>JabRefは、Google Scholarで検索を行い、引用をダウンロードすることができます。この機能を使うには、<b>検索→ウェブ検索</b>を選択すれば、操作盤がサイドペーンに表示されますので、そのドロップダウンメニューから<b>Google Scholar</b>を選択してください。</p>

    <p>検索を開始するには、問い合わせる単語を入力し、<b>Enter</b>を押すか、<b>取得</b>ボタンを押してください。</p>
