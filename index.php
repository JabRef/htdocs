...
<body>
  <div id="container">
	...
	<li class="item">November 29th, 2015</li>
	<li class="item_desc">Version 3.0</li>
    ...
    <div id="main">
      ...
      1.8 or newer), and should work equally well on Windows,
      ...
      <a href="https://www.ctan.org/pkg/bibtex">CTAN <acronym>BibTeX</acronym> package information page</a>.</p>

      <p><acronym>JabRef</acronym> also supports <a href="https://www.ctan.org/pkg/biblatex">BibLaTeX</a>.</p>
