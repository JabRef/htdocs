  ...
  <div id="container">
    ...
    <div id="rightpanel">
      ...
      <ul>
        ...
        <li><a href="journals/journal_abbreviations_geology_physics.txt">Geology and Physics abbreviation list</a> by an <a href="https://sourceforge.net/p/jabref/patches/164/">anoonymous user</a>.</li>
