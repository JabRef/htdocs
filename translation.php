...
<body>
  <div id="container">
	...
	<li>IntegrityMessage_.properties : small file containing messages for the database integrity check</li>
      ...
      <p>To make it easier to keep track of your translation, we recommend using an application called <a href="https://github.com/koppor/popeye">Popeye</a>. This application lets you set up a project including those property files and languages that you want to follow. You have to download <a href="langproper-0.55.jar">langproper-0.55.jar</a> from this homepage. This version properly handles the property files generated by JabRef. Sourcecode of Popeye 0.55 is available at <a href="https://github.com/koppor/popeye">github</a>.</p>
      ...
      <p>If you are still interested, you will need to contact the project manager - preferably through the <a href="https://lists.sourceforge.net/lists/listinfo/jabref-users">jabref-users mailing list</a>. Then you can send over your initial versions of the translation files, and your language can be added to the current development version of <acronym>JabRef</acronym>. You will be made a member of the project group. This requires you to have a user account at Github. This means that you will need to learn the basics of using the git version control system. The <a href="https://github.com/JabRef/jabref">JabRef's git repository page at Github</a> and the <a href="https://guides.github.com/">Github's Guide</a> are places to start learning this, although there are several other tutorials available on the web.</p>
